(function (global, factory) {
  ...
  function build() {
    ...
    eles.header = tableEle.querySelector('.big-grid__header__virtual'); // set the initial height
  ...
  function updateCell() {
    ...
    for (var rowIdx = view.startRow; rowIdx <= view.endRow; rowIdx++) {
      for (var columnIdx = view.startColumn; columnIdx <= view.endColumn; columnIdx++) {
        ...
        cellEle.className = 'big-grid__cell ' + (rowIdx % 2 === 0 ? 'big-grid__cell--even ' : 'big-grid__cell--odd ') + cell.class;
